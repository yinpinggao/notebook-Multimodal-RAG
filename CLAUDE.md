...
For detailed guidance, read `open-notebook/CLAUDE.md`. Key references:

| File | What It Covers |
|---|---|
| `open-notebook/CLAUDE.md` | Three-tier architecture, service pattern, deployment |
| `open-notebook/open_notebook/graphs/CLAUDE.md` | LangGraph workflows (source/chat/ask/transformation) |
| `open-notebook/open_notebook/ai/CLAUDE.md` | ModelManager, Esperanto library, AI provider system |
| `open-notebook/open_notebook/database/CLAUDE.md` | SeekDB operations, migrations, async patterns |
| `open-notebook/open_notebook/domain/CLAUDE.md` | Domain models, repository pattern |
| `open-notebook/open_notebook/seekdb/CLAUDE.md` | SeekDB client, vector retrieval, chunk storage |
| `open-notebook/open_notebook/vrag/CLAUDE.md` | VRAG multimodal RAG (image search, bbox crop, memory graph) |
| `open-notebook/api/CLAUDE.md` | FastAPI routers, service pattern |
| `open-notebook/frontend/src/CLAUDE.md` | Next.js/React, Zustand + TanStack Query, API integration |
| `open-notebook/commands/CLAUDE.md` | seekdb-commands job queue handlers |
| `open-notebook/prompts/CLAUDE.md` | Jinja2 prompt templates, workflow integration |
