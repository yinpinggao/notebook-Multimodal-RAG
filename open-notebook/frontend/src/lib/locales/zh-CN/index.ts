export const zhCN = {
  ...
  assistant: {
    ...
    selectThread: "选择线程",
    selectProjectHint: "先选择一个项目，再进入统一工作区。",
    singleWorkspaceHint: "资料、笔记、记忆和线程都收在一个工作区里。",
    commandPaletteHint: "搜索总览、项目、Agent、记忆、模型和设置。",
    commandPalettePlaceholder: "搜索总览、项目、Agent、记忆...",
    projectsHeading: "项目",
    currentMemoryHeading: "当前项目记忆",
    shortcutsHeading: "工作区",
    researchAgent: "研究 Agent",
    retrievalAgent: "检索 Agent",
    visualAgent: "视觉 Agent",
    synthesisAgent: "综合 Agent",
    knowledgeHint: "搜索、固定并拖拽资料或笔记，作为当前上下文。",
    agentHint: "围绕当前上下文持续追问，把回答沉淀成可复用记忆。",
    memoryHint: "查看项目长期记忆，并把需要的条目重新拉回当前上下文。",
    allKnowledge: "全部",
    addContext: "加入",
    inContext: "已加入",
    embeddedReady: "向量已就绪",
    embeddingPending: "向量处理中",
    insightsCount: "{count} 条 insight",
    emptyNotePreview: "这条笔记还没有内容。",
    advancedSettings: "高级设置",
    currentAgentLabel: "当前 Agent：{agent}",
    currentModeLabel: "问答模式：{mode}",
    currentContextLabel: "已选上下文：{count}",
    currentThreadLabel: "当前线程：{thread}",
    noneSelected: "未选择",
    newThread: "新线程",
    confidenceLabel: "置信度 {confidence}",
    waitingForAnswer: "等待下一次回答",
    generatingAnswer: "正在生成回答...",
    evidenceHeading: "证据",
    sendToAgent: "发送",
    askPlaceholder: "输入一个明确问题，或先拖入上下文再发问。",
    contextSelector: "选择上下文",
    clearContext: "清空",
    dropContextHint: "把资料、笔记或记忆拖到这里，限制下一次提问范围。",
    contextCountLabel: "已选 {count} 项",
    saveToMemory: "保存到记忆",
    saveAnswerToMemory: "保存回答到记忆",
    saveToMemoryHint: "把回答、笔记或消息保存成项目长期记忆。",
    memoryContent: "记忆内容",
    noMemoryRefs: "这条草稿记忆还没有证据引用。",
    searchMemory: "搜索记忆",
    refreshMemory: "刷新记忆",
    importMemory: "导入",
    exportMemory: "导出",
    ...
    allStatus: "全部状态",
    allTypes: "全部类型",
    noMemoryYet: "当前还没有项目记忆。",
    memoryStatus: "状态",
    memoryStatusDraft: "草稿",
    memoryStatusAccepted: "已接受",
    memoryStatusFrozen: "已冻结",
    memoryStatusDeprecated: "已过时",
    memoryTypeFact: "事实",
    memoryTypeTerm: "术语",
    memoryTypeDecision: "决策",
    memoryTypeRisk: "风险",
    memoryTypePreference: "偏好",
    memoryTypeQuestion: "问题",
    emptyWorkspaceTitle: "还没有项目",
    emptyWorkspaceDescription: "先建一个项目，再把资料、笔记、记忆和问答收进同一个工作区。",
    dashboardIntro: "继续最近项目、回到最近线程，或者先完成模型配置再进入工作区。",
    continueTitle: "继续处理",
    continueDescription: "回到最近活跃项目，或者直接接着最近线程往下做。",
    continueProjectFallback: "先看项目里的资料和笔记，再进入当前工作区继续推进。",
    continueThread: "继续线程",
    noProjectYetDescription: "先创建一个项目，最近工作区和最近线程才会出现在这里。",
    projectsDescription: "打开项目后，默认先进入知识库。",
    noProjectsTitle: "还没有项目列表",
    noProjectsDescription: "先建一个项目，再把资料、笔记、线程和记忆收回到 assistant 里。",
    quickActionsDescription: "不用进入完整工作区，先做下一步动作。",
    setupStatusTitle: "配置 / 状态",
    setupStatusDescription: "模型和凭证现在都集中在一个入口里。",
    configureModels: "配置模型",
    configureModelsDescription: "当前还没有可用的默认模型。先配置凭证、发现模型并分配默认值，再进入工作区。",
    availableModels: "可用模型",
    dashboardModelChat: "对话：{name}",
    dashboardModelVision: "视觉：{name}",
    dashboardModelEmbedding: "嵌入：{name}",
    pinnedContextHint: "把资料、笔记或记忆固定在这里，浏览项目时随时带着走。",
    previewTitle: "预览",
    previewHint: "先看当前 source 或 note，再决定要不要送进工作区。",
    noInsightsYet: "还没有抽取出的 insights。",
    sourcePreviewUnavailable: "这份资料已经就绪，但当前没有可展示的预览文本。要看完整内容，请从资料弹窗打开。",
    askInWorkspace: "在工作区提问",
    workspaceSupportHint: "把已固定上下文和更可能有用的项目记忆放在当前线程旁边。",
    recommendedMemory: "推荐记忆",
    memoryDetailTitle: "记忆详情",
    memoryDetailHint: "查看单条项目记忆，调整状态，再按需要送回工作区。",
    decayLabel: "衰减",
    sourceReferencesTitle: "来源引用",
    sourceReferencesHint: "查看当前记忆背后对应的资料引用。",
    sendToWorkspace: "发送到工作区",
    collapseKnowledge: "收起知识面板",
    collapseMemory: "收起记忆面板",
  },
  notebooks: {
    title: "笔记本",
    newNotebook: "创建笔记本",
  ...
  vrag: {
    title: "视觉 RAG",
    subtitle: "针对文档中的视觉内容提问",
    startConversation: "针对文档中的视觉内容提问",
    exampleQuestions: '例如："文档中有哪些图表？"或"描述第5页的图表"',
    newSession: "新会话",
    reset: "新建对话",
    deleteSession: "删除会话",
    maxSteps: "最大步数",
    ...
    index: {
      ...
      rebuildSuccess: "重建完成",
      rebuildError: "重建失败",
      rebuildIndexError: "重建索引失败",
      selectAll: "全选",
      noSources: "此笔记本中没有可用来源。",
      pdfOnlyError: "只有 PDF 文件可以用于视觉搜索索引。",
    },
  },
  settings: {
