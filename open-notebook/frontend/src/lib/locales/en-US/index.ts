export const enUS = {
  ...
  connectionErrors: {
    ...
    dbFailed1: "SeekDB is not running",
    ...
    checkSeekDB: "Check if SeekDB is running:",
  ...
  zhiyancang: {
    slogan: "Evidence-Driven Agentic Research OS",
    projects: "Projects",
    library: "Library",
    system: "System",
    workspace: "Workspace",
  ...
  assistant: {
    ...
    selectProjectHint: "Choose a project to open the shared workspace.",
    singleWorkspaceHint: "Sources, notes, memory, and threads stay in one workspace.",
    commandPaletteHint: "Search dashboard, projects, agents, memory, models, and settings.",
    commandPalettePlaceholder: "Search dashboard, projects, agents, memory...",
    projectsHeading: "Projects",
    currentMemoryHeading: "Current Project Memory",
    shortcutsHeading: "Workspace",
    researchAgent: "Research Agent",
    retrievalAgent: "Retrieval Agent",
    visualAgent: "Visual Agent",
    synthesisAgent: "Synthesis Agent",
    knowledgeHint: "Search, pin, and drag sources or notes into the current context.",
    agentHint: "Ask, follow up, and turn selected context into evidence-backed answers.",
    memoryHint: "Review long-term project memory and add it back into context when needed.",
    allKnowledge: "All",
    addContext: "Add",
    inContext: "Added",
    embeddedReady: "Embedding ready",
    embeddingPending: "Embedding pending",
    insightsCount: "{count} insights",
    emptyNotePreview: "No note content yet.",
    advancedSettings: "Advanced",
    currentAgentLabel: "Current agent: {agent}",
    currentModeLabel: "Ask mode: {mode}",
    currentContextLabel: "Selected context: {count}",
    currentThreadLabel: "Current thread: {thread}",
    noneSelected: "Not selected",
    newThread: "New thread",
    confidenceLabel: "Confidence {confidence}",
    waitingForAnswer: "Waiting for the next answer",
    generatingAnswer: "Generating answer...",
    evidenceHeading: "Evidence",
    sendToAgent: "Send",
    askPlaceholder: "Ask a concrete question, or drop pinned context here before sending.",
    contextSelector: "Choose context",
    clearContext: "Clear",
    dropContextHint: "Drag sources, notes, or memory here to scope the next question.",
    contextCountLabel: "{count} item(s) selected",
    saveToMemory: "Save to memory",
    saveAnswerToMemory: "Save answer to memory",
    saveToMemoryHint: "Save an answer, note, or message as long-term project memory.",
    memoryContent: "Memory content",
    noMemoryRefs: "No evidence references are attached to this draft memory.",
    ...
    allTypes: "All types",
    noMemoryYet: "No project memory yet.",
    memoryStatus: "Status",
    memoryStatusDraft: "Draft",
    memoryStatusAccepted: "Accepted",
    memoryStatusFrozen: "Frozen",
    ...
    memoryTypeQuestion: "Question",
    emptyWorkspaceTitle: "No project yet",
    emptyWorkspaceDescription: "Create a project first, then bring sources, notes, memory, and chat into one workspace.",
    dashboardIntro: "Continue the last project, jump back into a thread, or finish model setup before asking anything.",
    continueTitle: "Continue",
    continueDescription: "Pick up the last active project or go straight back to its latest thread.",
    continueProjectFallback: "Open the project, review sources and notes, then move into the active workspace.",
    continueThread: "Continue Thread",
    noProjectYetDescription: "Create a project first, then the recent workspace and recent thread will show up here.",
    projectsDescription: "Opening a project starts in Knowledge Hub by default.",
    noProjectsTitle: "No projects",
    noProjectsDescription: "Create one project, then bring sources, notes, threads, and memory back into the assistant.",
    quickActionsDescription: "Start the next step without entering the full workspace.",
    setupStatusTitle: "Setup / Status",
    setupStatusDescription: "Models and credentials live in one place now.",
    configureModels: "Configure Models",
    configureModelsDescription: "No usable default models are configured yet. Set credentials, discover models, and assign defaults before using the workspace.",
    availableModels: "Available Models",
    dashboardModelChat: "Chat: {name}",
    dashboardModelVision: "Vision: {name}",
    dashboardModelEmbedding: "Embedding: {name}",
    pinnedContextHint: "Pin sources, notes, or memory to keep them close while you browse this project.",
    previewTitle: "Preview",
    previewHint: "Inspect the current source or note before sending it into the workspace.",
    noInsightsYet: "No extracted insights yet.",
    sourcePreviewUnavailable: "This source is ready, but the preview text is not available yet. Open it from the source dialog for the full document view.",
    askInWorkspace: "Ask in Workspace",
    workspaceSupportHint: "Keep pinned context and the most useful project memory close to the active thread.",
    recommendedMemory: "Recommended Memory",
    memoryDetailTitle: "Memory Detail",
    memoryDetailHint: "Review one project memory, update its status, and send it back into the workspace when needed.",
    decayLabel: "Decay",
    sourceReferencesTitle: "Source References",
    sourceReferencesHint: "See which source excerpts support the selected memory.",
    sendToWorkspace: "Send to Workspace",
    collapseKnowledge: "Collapse knowledge panel",
    collapseMemory: "Collapse memory panel",
  },
  notebooks: {
    title: "Notebooks",
    newNotebook: "New Notebook",
  ...
  vrag: {
    title: "Visual RAG",
    subtitle: "Ask questions about visual content in your documents",
    startConversation: "Ask questions about visual content in your documents",
    exampleQuestions: 'Try: "What charts are in this document?" or "Describe the diagram on page 5"',
    ...
    dag: "DAG",
    messages: "Msgs",
    dagEmpty: "DAG will appear here as the agent reasons",
    noMessages: "No reasoning steps yet",
    noImages: "No images retrieved yet",
    searchResults: "Search Results",
    evidenceNodes: "Evidence Nodes",
    placeholder: "Ask about visual content",
    steps: "Steps",
    reasoning: "Reasoning...",
    ...
    index: {
      ...
      rebuildIndexError: "Rebuild index failed",
      selectAll: "Select all",
      noSources: "No sources available in this notebook.",
      pdfOnlyError: "Only PDF files can be indexed for visual search.",
    },
  },
  settings: {
