...
export function AddSourceDialog({ 
  ...
  useEffect(() => {
    ...
    // Reset form with proper embed value based on settings even when there
    // are no default transformations, otherwise sources can be submitted with
    // embed=false before settings finish loading.
