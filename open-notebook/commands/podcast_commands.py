...
async def generate_podcast_command(
    ...
    try:
        ...
        # 1. Load Episode and Speaker profiles from the active datastore
        ...
        episode_profiles = [profile.model_dump() for profile in await EpisodeProfile.get_all()]
        speaker_profiles = [profile.model_dump() for profile in await SpeakerProfile.get_all()]

        # Transform the profiles array into a dictionary for podcast-creator
        ...
        episode = PodcastEpisode(
            ...
            command=input_data.execution_context.command_id if input_data.execution_context else None,
            briefing=briefing,
