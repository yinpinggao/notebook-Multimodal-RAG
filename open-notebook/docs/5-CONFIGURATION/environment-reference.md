...
| Variable | Required? | Default | Description |
|----------|-----------|---------|-------------|
| `SEEKDB_URL` | Yes | ws://seekdb:3030/rpc | SeekDB WebSocket connection URL |
| `SEEKDB_USER` | Yes | root | SeekDB username |
| `SEEKDB_PASSWORD` | Yes | root | SeekDB password |
| `SEEKDB_NAMESPACE` | Yes | open_notebook | SeekDB namespace |
| `SEEKDB_DATABASE` | Yes | open_notebook | SeekDB database name |
...
| Variable | Required? | Default | Description |
|----------|-----------|---------|-------------|
| `SEEKDB_COMMANDS_RETRY_ENABLED` | No | true | Enable retries on failure |
| `SEEKDB_COMMANDS_RETRY_MAX_ATTEMPTS` | No | 3 | Maximum retry attempts |
| `SEEKDB_COMMANDS_RETRY_WAIT_STRATEGY` | No | exponential_jitter | Retry wait strategy (exponential_jitter/exponential/fixed/random) |
| `SEEKDB_COMMANDS_RETRY_WAIT_MIN` | No | 1 | Minimum wait time between retries (seconds) |
| `SEEKDB_COMMANDS_RETRY_WAIT_MAX` | No | 30 | Maximum wait time between retries (seconds) |
...
| Variable | Required? | Default | Description |
|----------|-----------|---------|-------------|
| `SEEKDB_COMMANDS_MAX_TASKS` | No | 5 | Maximum concurrent database tasks |
...
SEEKDB_URL=ws://seekdb:3030/rpc
SEEKDB_USER=root
SEEKDB_PASSWORD=password
SEEKDB_NAMESPACE=open_notebook
SEEKDB_DATABASE=open_notebook
```
...
SEEKDB_USER=production_user
SEEKDB_PASSWORD=secure_password
```
...
- [ ] Set database credentials (`SEEKDB_*`)
- [ ] Start services
...
- [ ] Change `SEEKDB_PASSWORD` in production
- [ ] Try a test chat
