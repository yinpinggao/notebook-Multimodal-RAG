...
class ModelCreate(BaseModel):
    ...
    provider: str = Field(
        ..., description="Provider name (e.g., tongyi, deepseek, ollama)"
    )
    type: str = Field(
        ...,
...
class ProviderCatalogFieldResponse(BaseModel):
    name: str
    label: str
    field_type: str
    target: str
...
class ProviderCatalogEntryResponse(BaseModel):
    ...
    credential_fields: List[ProviderCatalogFieldResponse] = Field(default_factory=list)


class ProviderCatalogResponse(BaseModel):
    providers: List[ProviderCatalogEntryResponse]
...
class CreateCredentialRequest(BaseModel):
    ...
    provider: str = Field(
        ..., description="Provider name (tongyi, wenxin, deepseek, doubao, spark, kimi, hunyuan, zhipu, ollama)"
    )
    modalities: List[str] = Field(
        default_factory=list,
        description="Supported modalities (language, embedding, text_to_speech, speech_to_text, vision)",
    )
    ...
    extra_config: Optional[Dict[str, Any]] = Field(
        default=None, description="Provider-specific extra configuration"
    )
