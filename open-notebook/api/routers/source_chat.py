...
async def get_source_chat_sessions(source_id: str = Path(..., description="Source ID")):
    ...
    try:
        ...
        sessions = []
        session_rows = await seekdb_business_store.list_source_chat_sessions(
            full_source_id
        )
...
async def get_source_chat_session(
    ...
    try:
        ...
        relation_exists = await seekdb_business_store.relation_exists(
            "refers_to", full_session_id, full_source_id
        )
...
async def stream_source_chat_response(
    ...
    try:
        ...
        state_values["source"] = source.model_dump(mode="json") if source else None
        ...
        state_values["context"] = evidence.get("context_text")
